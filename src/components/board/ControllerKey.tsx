...
const ControllerKey = ({ label }: props) => {
  ...
  return (
    <button
      className="p-6 rounded-lg text-center  text-gray-300 bg-blue-950 aspect-[5/3] text-3xl font-medium border-2 border-blue-950 hover:border-gray-600 transition active:scale-95 hover:bg-[#23346E] hover:text-gray-100"
      onClick={fillNumber}
    >
      {label}
    </button>
